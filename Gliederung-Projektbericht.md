...
- Definition der Zielgruppen (Hörer:innen und Radiomoderator:innen)
- Geplantes Endprodukt (interaktive Radio-App Prototyp)

1.3 Vorgehensweise und Methodik
- Überblick über Entwicklungsansatz (Sprints, Scrum Light?! (Dailys, Aufgabenteilung, Gegencheck))
- Tech-Stack (React + Capacitor, Design-Adds, Prettier, Backend-Stub etc.)
- Mobile first + Backend Stub impl, when needed
- Kurzer Überblick über die Gliederung des Berichts

## 2. Projektplanung (2 - 2.5)
2.1 Projektorganisation
- Rollenverteilung im Team
- Kommunikation (Teams) 
- Kollaboration (GitHub)

2.2 Projektphasen und Zeitplanung
- Projektstruktur mit Meilensteinen:
  - Sprint 1: Stack-Test + Grober Backend-Stub
  - Sprint 2: UI/UX + Grundkonzept
  - Sprint 3: User Stories 1-5
  - Sprint 4: Teststrategie planen + Refactoring
  - Sprint 5: Tests implementieren + Refactoring

2.3 Ressourcenplanung
- Software (IDE, Frameworks, Capacitor, Emulatoren)
...
- Entscheidungen zu Framework/Sprachen
- Sicherheits- und Authentifizierungskonzept (Login/Register-Funktion, Tokenhandling)

3.2 Frontend-Implementierung
- UI/UX-Konzept (Layout-Aufbau, Navigation, mobile Responsive Design)
- Beschreibung Views (Home, Playlist, Wishes, Login/Register, Moderatorbewertung)
- Codebeispiele?
- Wiederkehrende Komponenten? TailwindCSS/DaisyUI?
...
- Datenaustausch (ein Beispiel?)
- Rollen und Authentifizierung
- Fehler- und Ausnahmebehandlung

3.5 Tests und Qualitätssicherung?
- Vorgehensweise bei Tests (unit testsim frontend, manuell moderator:in/ hörer:in)
- Screenshots?

## 4. Ergebnisse und Reflexion (2)
4.1 Projektergebnisse
- Implementierung vs. User Stories
